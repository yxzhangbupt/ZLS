...
(function (a, b, c) {
    var d = {
        version: "2.7.4", canvasList: [], modules: {}, inits: {}, plugins: {}, core: function (a) {
            ...
            if (this.settings.canvas.nodeName && this.settings.canvas.nodeName.toLowerCase() === "canvas")this.canvasElement = this.settings.canvas; else if (typeof this.settings.canvas == "string")this.canvasElement = b.querySelector(this.settings.canvas); else return !1;
            this.canvas = this.canvasElement.getContext("2d");
            var e = this.canvasElement.width, f = this.canvasElement.height;
            Object.defineProperty(this, "width", {
                enumerable: !0, configurable: !0, set: function (a) {
            ...
            for (var c in d.modules) {
                if (this[c].wrapper === !0)for (var g in this[c])typeof this[c][g] == "object" && typeof this[c][g].setCore == "function" ? this[c][g] = this[c][g].setCore(this) : typeof this[c][g].setCore == "function" && this[c][g].setCore(this), this[c].core = this;
                this[c].core = this
            }
            for (var h in d.inits)if (typeof d.inits[h] == "string" && typeof this[h][d.inits[h]] == "function")this[h][d.inits[h]](); else if (d.inits[h] === "object")for (var i in d.inits[h])typeof this[h][d.inits[h][i]] == "function" && this[h][d.inits[h][i]]();
            var j = this.settings.plugins;
            if (j.length > 0)for (var k = 0, l = j.length; k < l; k++)typeof d.plugins[j[k]] == "function" && d.plugins[j[k]].call(this)
        ...
        }, isDomReady: !1, isDomReadyListening: !1, domReadyHandlers: [], triggerDomReadyHandlers: function () {
            var a, b, c, d;
    ...
    d.core.prototype = {
        ...
        var a = Array.prototype.slice.call(arguments), b = a[a.length - 1], c = a.splice(0, 1)[0], e = a.splice(0, 1)[0], f, g = [], h;
        b.exclude && JSON.stringify(b) === JSON.stringify({exclude: b.exclude}) && (g = b.exclude);
        if (e !== b || g.length === 0)for (f in e) {
        ...
        a.domEventHandlers.push({obj: b, event: c, handler: d, useCapture: !!e}), b.addEventListener(c, d, e)
        ...
        var d = Object.getOwnPropertyDescriptor(a, b), e = Object.getPrototypeOf(a);
        ...
        a.requestAnimationFrame || (a.requestAnimationFrame = function (c, d) {
            var e = (new Date).getTime(), f = Math.max(0, 16 - (e - b)), g = a.setTimeout(function () {
                c(e + f)
            }, f);
            b = e + f;
            return g
        ...
        if (this.console) {
            var a, b = Array.prototype.slice.call(arguments), c = b.length;
    ...
    var e = function () {
        var a = {
            ...
            }, currentFrame: 1, timeline: 0, running: !1, set fps(a) {
    ...
    var f = function () {
        return {
            keysDown: {}, keyPressTimers: {}, modifiedKeys: [], init: function () {
                var a = this;
                ...
                if (!!c.enabled) {
                    ...
                    if (a.type === "keyup")if (!this.anyKeysDown())for (b in this.keyPressTimers)clearInterval(this.keyPressTimers[b]); else clearInterval(this.keyPressTimers[b])
                }
    ...
    var g = function () {
        return {
            ...
            canvasHandler: function (a, b) {
                ...
                if (a.type === "mouseup" && !e && !this.canvasUpEventTriggered)d.triggerPointerEvent(this.types.mouseup, d.frontObject, "mouse", a), d.triggerPointerEvent(this.types.mouseup, this.core.canvasElement, "mouse", a), this.canvasUpEventTriggered = !0; else {
                    if (!b && !e)return;
            ...
            getPos: function (b) {
                var c = this.core.canvasElement, d = c.getBoundingClientRect(), e = c.width / c.clientWidth, f = c.height / c.clientHeight, g = b.pageX - a.pageXOffset, h = b.pageY - a.pageYOffset, i = e * (g - Math.round(d.left)), j = f * (h - Math.round(d.top));
                return {x: i, y: j}
            },
            ...
            cursor: function (a) {
                if (~a.indexOf("url(")) {
                    var b = /url\((.*?)\)(\s(.*?)\s(.*?)|)($|,.*?$)/.exec(a), c = b[5] ? b[5] : "";
    ...
    var h = function () {
        return {
            ...
            canvasHandler: function (a, b) {
                var d, e, f, g, h, i;
                d = this.core.events, e = this.onCanvas(a);
                if (a.type === "touchend" && !e && !this.canvasUpEventTriggered)d.triggerPointerEvent(this.types.touchend, d.frontObject, "touch", a), d.triggerPointerEvent(this.types.touchend, this.core.canvasElement, "touch", a), this.canvasUpEventTriggered = !0; else {
                    if (!b && !e)return;
            ...
            getPos: function (b) {
                ...
                if (f !== c && f.length > 0) {
                    b = f[0];
                    var g = this.core.canvasElement, h = g.getBoundingClientRect(), i = g.width / g.clientWidth, j = g.height / g.clientHeight, k = b.pageX - a.pageXOffset, l = b.pageY - a.pageYOffset;
    ...
    var i = function () {
        return {
            transformPointerPosition: function (a, b, c, d, e) {
                ...
                if (typeof a == "object") {
                    var f = a.parent, g = [], h = {x: 0, y: 0}, i, j, k, l, m;
                    g.push(a);
                ...
                var n = a, o = e.x >= b && e.y <= c, p = e.x >= b && e.y >= c, q = e.x <= b && e.y >= c, r = e.x <= b && e.y <= c, s = Math.sqrt(Math.pow(e.x - b, 2) + Math.pow(e.y - c, 2)), n = (n / 360 - Math.floor(n / 360)) * 360 - d, t, u, v, w = s === 0 ? 0 : Math.abs(e.y - c) / s;
                if (o || q)t = (180 - n - Math.asin(w) * 180 / Math.PI) * Math.PI / 180, u = b + Math.cos(t) * s * (o ? -1 : 1), v = c + Math.sin(t) * s * (o ? -1 : 1); else if (r || p)t = (Math.asin(w) * 180 / Math.PI - n) * Math.PI / 180, u = b + Math.cos(t) * s * (r ? -1 : 1), v = c + Math.sin(t) * s * (r ? -1 : 1);
                return {x: u, y: v}
            }, isPointerInside: function (a, b) {
                var c = a.getOrigin();
                if (a.type === "line") {
                    var d = Math.abs(a._.end_x - a.abs_x), e = Math.abs(a._.end_y - a.abs_y), f = Math.sqrt(d * d + e * e), g = a.start, h = a.end, i = g.x < h.x && g.y < h.y || g.x > h.x && g.y > h.y ? -1 : 1, j = Math.asin(e / f) * (180 / Math.PI) * i, k = this.transformPointerPosition(a, a.abs_x, a.abs_y, j, b);
                    return k.x > a.abs_x - f - c.x && k.x < a.abs_x + f - c.x && k.y > a.abs_y - a.strokeWidth / 2 - c.y && k.y < a.abs_y + a.strokeWidth / 2 - c.y
                }
                if (a.type === "text") {
                    var k = this.transformPointerPosition(a, a.abs_x, a.abs_y, 0, b), l = a.strokeWidth / 2, m = a._.lines, n = m.length, o = a.size * a.lineHeight, p = a.align, q = this.core.canvasElement.dir === "rtl", r, s, t, u, v, w, x, y;
                    r = {
                        top: a.size * .05,
                        hanging: a.size * -0.12,
                        middle: a.size * -0.47,
                ...
                if (a.shapeType === "rectangular") {
                    var k = this.transformPointerPosition(a, a.abs_x, a.abs_y, 0, b), l = a.strokePosition === "outside" ? a.strokeWidth : a.strokePosition === "center" ? a.strokeWidth / 2 : 0;
                ...
                if (a.type === "ellipse" && a.radius_x === a.radius_y) {
                    var k = this.transformPointerPosition(a, a.abs_x, a.abs_y, 0, b), f = Math.sqrt(Math.pow(k.x - a.abs_x + c.x, 2) + Math.pow(k.y - a.abs_y + c.y, 2));
                    return f < a.radius_x + a.strokeWidth / 2
                }
                if (a.type === "ellipse") {
                    var k = this.transformPointerPosition(a, a.abs_x, a.abs_y, 0, b), z = a.radius_x + a.strokeWidth / 2, A = a.radius_y + a.strokeWidth / 2;
                    k.x -= a.abs_x + c.x, k.y -= a.abs_y + c.y;
                    return k.x * k.x / (z * z) + k.y * k.y / (A * A) < 1
                }
                if (a.type === "polygon") {
                    var k = this.transformPointerPosition(a, a.abs_x, a.abs_y, 0, b), B = a.radius + a.strokeWidth / 2, C = a.sides, D = C - 1, E = !1, s, F, G;
                    for (s = 0; s < C; s++)F = {
                ...
                if (a.type === "arc") {
                    var H = a.end - a.start, I = a.direction === "clockwise" ? (H < 0 ? 360 : 0) + (H % 360 ? H % 360 : H > 0 ? 360 : 0) : Math.abs(H), J = a.direction === "clockwise" ? a.start * -1 : a.end * -1, k = this.transformPointerPosition(a, a.abs_x, a.abs_y, J, b), f = Math.sqrt(Math.pow(k.x - a.abs_x + c.x, 2) + Math.pow(k.y - a.abs_y + c.y, 2)), B = a.radius, K = {}, L = {}, z, M, N, j;
                    ...
                    if (B === a.strokeWidth / 2 || a.pieSection) {
                        ...
                        if (I > 180) {
                            ...
                            var U = 90 - (90 - N) - (90 - z);
                            if (k.y < K.y && k.x < K.x)j = z - Math.acos(Math.abs(k.y - K.y) / Math.sqrt(Math.pow(k.x - K.x, 2) + Math.pow(k.y - K.y, 2))) * 180 / Math.PI; else if (k.y > K.y && k.x >= K.x)j = U - Math.acos(Math.abs(k.x - K.x) / Math.sqrt(Math.pow(k.x - K.x, 2) + Math.pow(k.y - K.y, 2))) * 180 / Math.PI; else {
                    ...
                    if (B > 0) {
                        var k = this.transformPointerPosition(a, a.abs_x, a.abs_y, 0, b), c = a.getOrigin(), f = Math.sqrt(Math.pow(k.x - a.abs_x + c.x, 2) + Math.pow(k.y - a.abs_y + c.y, 2));
                        return f < B
                    }
                }
            }
    ...
    var j = function () {
        return {
            enabled: !0, eventTypes: {}, init: function () {
                        ...
                        if (b !== this.frontObject) {
                            if (this.frontObject) {
                                ...
                                if (!~k.indexOf(this.frontObject)) {
                                    ...
                                    if (!~k.indexOf(b))this.triggerChain(k, h); else {
                                        l = [];
                ...
                var d = "altKey ctrlKey metaKey shiftKey button charCode keyCode clientX clientY pageX pageY screenX screenY detail eventPhase isChar touches targetTouches changedTouches scale rotation".split(" "), e = d.length, f, g, h, i;
                f = {
                    originalEvent: a,
    ...
    var k = function () {
        return {
            objects: [], translation: {x: 0, y: 0}, changeZorder: function (a, b, d) {
                var e = a.children, f = e[b], g = e[d], h, i, j, k;
                if (f !== c) {
                    if (b === d)return;
                ...
                var b = this.core.canvas, d, e, f, g, h, i, j, k, l, m, n, o, p, q;
                for (d = 0, e = a.length; d < e; d++) {
                    f = a[d];
    ...
    var l = function () {
        return {
            bg: "", value: "", type: "transparent", loaded: !1, init: function () {
                ...
                if (this.type === "color")this.bg = a, this.core.timeline && !this.core.timeline.running && this.core.draw.redraw(!0), this.loaded = !0; else if (this.type === "gradient")this.bg = this.core.style ? this.core.style.getGradient(a, 0, 0, this.core.width, this.core.height) : "", this.core.timeline && !this.core.timeline.running && this.core.draw.redraw(!0), this.loaded = !0; else if (this.type === "image") {
                    var c = /image\((.*?)(,(\s|)(repeat|repeat-x|repeat-y|no-repeat)|)\)/.exec(a), d = c[1], e = c[4] || "repeat", f = new Image;
            ...
            current: "none", scenes: {}, create: function (a, b) {
                ...
                return {
                    name: "", objects: [], loaded: !1, add: function (a) {
                        ...
                        if (!this.loaded) {
                            var a = this.objects, b, d = a.length;
    ...
    var n = function () {
        return {
            getStroke: function (a, b) {
                ...
                j && e.push(j.join(" "));
                var k = ["outside", "center", "inside"], l = "", h, m = e.length, n, o, j, p;
                if (m >= 3)if (!~k.indexOf(e[0])) {
                ...
                m === 2 && (e = {pos: "center", width: parseFloat(e[0]), color: e[1]}), e.length && (e = {
                    pos: "center",
                    width: 0,
                    color: ""
                });
                ...
                var f, g, h, i = [], j, k, l, m, n, o, p = ["top", "bottom", "left", "right"], q, r, s = [], t, u;
                g = /\((.*)\)/.exec(a)[1];
                ...
                if (i.length === 1) {
                    if (i[0] === "top")l = b + d / 2, m = c, n = b + d / 2, o = c + e; else if (i[0] === "right")l = b + d, m = c + e / 2, n = b, o = c + e / 2; else if (i[0] === "bottom")l = b + d / 2, m = c + e, n = b + d / 2, o = c; else if (i[0] === "left")l = b, m = c + e / 2, n = b + d, o = c + e / 2; else if (~i[0].indexOf("deg")) {
                        var v, w, x, y, z, A, B, C, D = Math.PI, E = b + d / 2, F = c + e / 2;
                ...
                var g, h = ["left", "center", "right"], i = ["top", "center", "bottom"], j = {
                    left: b,
                    center: b + e / 2,
                    right: b + e
                }, k = {
                    ...
                    center: d + f / 2,
                    bottom: d + f
                }, l = ["closest-side", "closest-corner", "farthest-side", "farthest-corner", "contain", "cover"], m, n, o, p, q, r = [], s, t, u, v = 0, w = [{
                    x: c,
                    y: c,
                    r: 0
                }, {x: c, y: c, r: c}], x, y, z, A, B = !1;
                m = /\((.*)\)/.exec(a)[1];
                ...
                for (n = 0; n < 2; n++)if (~m[n].indexOf(" ")) {
                    u = m[n].split(" ");
                    if (u[0] === "center")w[n].x = u[0], w[n].y = u[1], v = n + 1; else if (~h.indexOf(u[0]))w[n].x = u[0], v = n + 1, ~i.indexOf(u[1]) && (w[n].y = u[1]); else if (~i.indexOf(u[0]))w[n].y = u[0], v = n + 1, ~h.indexOf(u[1]) && (w[n].x = u[1]); else if (!isNaN(parseFloat(u[0]))) {
                        w[n].x = u[0], v = n + 1;
                ...
                if (a.length > 0) {
                    var e = a.split(" "), f = e.length, g, a, h, i, j = "", k = ["normal", "italic", "oblique"], l = ["normal", "small-caps"], m = ["normal", "bold", "bolder", "lighter", "100", "200", "300", "400", "500", "600", "700", "800", "900"], n = {};
                    for (g = 0; g < f; g++) {
                        a = e[g];
                        if (~k.indexOf(a) && !n.style)n.style = a; else if (~l.indexOf(a) && !n.variant)n.variant = a; else if (~m.indexOf(a) && !n.weight)n.weight = a; else if (~a.indexOf("/") && !n.size && !n.lineHeight)h = a.split("/"), isNaN(parseInt(h[0])) || (n.size = parseInt(h[0])), isNaN(parseFloat(h[1])) || (n.lineHeight = parseFloat(h[1]), n.lineHeightUnit = h[1].indexOf("px") > -1 ? "px" : "relative"); else if (!n.size && /\d+[a-z]{2}(?!\/)/.test(a))isNaN(parseInt(a)) || (n.size = parseInt(a)); else if (isNaN(parseInt(a)) && !n.family) {
                            j = "";
                ...
                var c = {}, d;
                if (typeof a == "object")c.offsetX = isNaN(parseFloat(a.offsetX)) ? 0 : parseFloat(a.offsetX), c.offsetY = isNaN(parseFloat(a.offsetY)) ? 0 : parseFloat(a.offsetY), c.blur = isNaN(parseFloat(a.blur)) ? 0 : parseFloat(a.blur), c.color = this.isColor(a.color) ? a.color : "#000"; else if (typeof a == "string") {
                    var d = /^(.*?)\s(.*?)\s(.*?)\s(.*?)$/.exec(a);
    ...
    var o = function () {
        var a = {
            ...
            animate: function (a, b) {
                var c = this.parseArguments(b), d = c.properties, e = c.options, f = this.queues.create(a, e.queue), g = {
                    obj: a,
                    properties: d,
                    startValues: {},
                    diffValues: {},
                    options: {queue: f, duration: e.duration, easing: e.easing, callback: e.callback}
                };
                f.add(g), f.run()
            },
            ...
            parseProperties: function (a, b) {
                var c = {}, e = {};
                for (var f in a)if (d.isNumber(a[f]))c[f] = b[f] || 0, e[f] = a[f] - (b[f] || 0); else if (typeof a[f] == "object") {
            ...
            setObjectProperty: function (a, b, c, e, f) {
                if (d.isNumber(c))a[b] = c + e * f; else for (var g in c)this.setObjectProperty(a[b], g, c[g], e[g], f)
            },
            setEndValues: function (a) {
                var b = a.obj, c = a.startValues, d = a.diffValues;
            ...
            getAnimateArguments: function (a) {
                ...
                return {duration: b, easing: d, queue: e ? c : "default", callback: f}
            },
            ...
            easing: {
                "ease-in": function (a) {
                    ...
                    var f = 0, g = 0, h = 1, i = 1, j = h - 3 * c + 3 * a - f, k = 3 * c - 6 * a + 3 * f, l = 3 * a - 3 * f, m = f, n = i - 3 * d + 3 * b - g, o = 3 * d - 6 * b + 3 * g, p = 3 * b - 3 * g, q = g, r = e, s = 5, t, u, v, w;
    ...
    var p = function () {
        ...
        return {
            ...
            set stroke(a) {
                ...
                if (~b.color.indexOf("image(")) {
                    var c = /image\((.*?)(,(\s|)(repeat|repeat-x|repeat-y|no-repeat)|)\)/.exec(b.color), d = c[1], e = c[4] || "repeat", f = new Image, g = this;
            ...
            set fill(a) {
                if (~a.indexOf("image(")) {
                    var b = /image\((.*?)(,(\s|)(repeat|repeat-x|repeat-y|no-repeat)|)\)/.exec(a), c = b[1], d = b[4] || "repeat", e = new Image, f = this;
            ...
            set x(a) {
                ...
                var b = this.children, d = b.length, e;
            ...
            trigger: function (a, b) {
                var c = this.core.events, d = c.getParentChain(this, !0, !0);
            ...
            scaleTo: function (a, b) {
                var c = this.shapeType === "rectangular" ? this.width : this.radius, d = this.shapeType === "rectangular" ? this.height : this.radius, e = this.getArgs(a, b, c, d);
            ...
            fadeTo: function () {
                var a = Array.prototype.slice.call(arguments);
                this.core.animation.animate(this, [{opacity: a.splice(0, 1)[0]}].concat(a));
                return this
            },
            dragAndDrop: function (a) {
                a = a === c ? {} : a;
                if (a === !1 && this.draggable === !0)this.draggable = !1, this.unbind("mousedown touchstart", this._.drag_start), this.core.unbind("mouseup touchend", this._.drag_end), this.core.unbind("mousemove touchmove", this._.drag_move); else if (!this.draggable) {
                    this.draggable = !0, this.dragging = !1;
                    var b = this, d = {x: 0, y: 0}, e = {x: 0, y: 0}, f = {x: 0, y: 0};
            ...
            getOrigin: function () {
                var a, b, c = this.origin, d = this.shapeType;
            ...
            clone: function (a) {
                a = a || {}, a.drawn = !1;
                var b = this.parent, e = this.core.display[this.type](a), f = {}, g = ["core", "events", "children", "parent", "img", "fill", "strokeColor", "added"], h = ["abs_x", "start_x", "end_x"], i = ["abs_y", "start_y", "end_y"], j, k, l, m, n, o, p, q, r;
                j = function (a, d) {
                    for (k in a) {
                ...
                if (n.length > 0)for (m = 0; m < n.length; m++)o = n[m].clone(), e.children.push(o), o.parent = e, a.x && (p = Math.abs(n[m].abs_x - this.x), o.x = p), a.y && (q = Math.abs(n[m].abs_y - this.y), o.y = q);
                return e
            },
        ...
        var g = this, h = this.core, i = function (c, f) {
            return d.extend({
                core: f, type: a, shapeType: "rectangular", draw: function () {
    ...
    var r = function (a, b) {
        return d.extend({
            core: b, shapeType: "rectangular", draw: function () {
                var a = this.core.canvas, b = this.getOrigin(), c = this.abs_x - b.x, d = this.abs_y - b.y;
    ...
    var s = function (a, b) {
        return d.extend({
            ...
            draw: function () {
                var a = this.core.canvas, b = this, d = this.getOrigin(), e = this.abs_x - d.x, f = this.abs_y - d.y, g, h;
                if (this.loaded && this.core.draw.objects[this.zIndex] !== c && this.img.width > 0 && this.img.height > 0) {
                    ...
                    if (this.tile) {
                        var i = Math.ceil(g / this.tile_width), j = Math.ceil(h / this.tile_height), k, l;
                        a.save(), a.beginPath(), a.moveTo(e, f), a.lineTo(e + g, f), a.lineTo(e + g, f + h), a.lineTo(e, f + h), a.lineTo(e, f), a.clip();
                        for (l = 0; l < j; l++)for (k = 0; k < i; k++)a.drawImage(this.img, e + k * (this.tile_width + this.tile_spacing_x), f + l * (this.tile_height + this.tile_spacing_y), this.tile_width, this.tile_height);
    ...
    var w = function (a, b) {
        return d.extend({
            ...
            draw: function () {
                var a = this.core.canvas, b = this.getOrigin(), c = this.abs_x - b.x, d = this.abs_y - b.y;
                a.beginPath();
                if (this.radius_x === this.radius_y)a.arc(c, d, this.radius_x, 0, Math.PI * 2, !1); else {
                    var e = .276142374915397, f = {x: this.radius_x * 2 * e, y: this.radius_y * 2 * e};
    ...
    var x = function (a, b) {
        return d.extend({
            ...
            draw: function () {
                var a = this.core.canvas, b = this.getOrigin(), c = this.abs_x - b.x, d = this.abs_y - b.y, e = {
                    x: 0,
                    y: 0
                }, f = this.sides, g = this.radius, h, i, j;
                a.beginPath();
    ...
    var y = function (a, b) {
        return d.extend({
            ...
            draw: function () {
                var a = this.core.canvas, b = this.getOrigin(), c = this.core.draw.translation;
    ...
    var z = function (a, b) {
        return d.extend({
            ...
            init: function () {
                if (this.image !== c) {
                    var a = this, b = this.image.nodeName && this.image.nodeName.toLowerCase() === "img" ? "htmlImg" : "newImg";
            ...
            draw: function () {
                var a = this, b = this.core.canvas, d = this.getOrigin(), e = this.abs_x - d.x, f = this.abs_y - d.y, g;
                if (this.loaded) {
